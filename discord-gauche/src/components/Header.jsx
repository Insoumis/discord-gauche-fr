    ...
    return (
        <header className="text-white h-[60px] flex absolute w-full">
            <nav className="mx-auto flex-1 flex flex-wrap justify-between items-center">
                ...
                <a tabIndex="2" href="#" className="imageAnchor mr-[20px] ml-[10px] cursor-pointer focus:bg-noir focus:invert hover:bg-noir hover:invert p-[10px] transition-all duration-500 rounded-full outline-none">
